...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','app.py',33),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','app.py',37),
  ('expression -> term','expression',1,'p_expression_term','app.py',41),
  ('term -> term TIMES factor','term',3,'p_term_times','app.py',45),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','app.py',49),
  ('term -> factor','term',1,'p_term_factor','app.py',53),
  ('factor -> NUMBER','factor',1,'p_factor_number','app.py',57),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','app.py',61),
]
